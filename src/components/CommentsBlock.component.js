...
export const CommentsBlock = props => {
    ...
    return (
        <View style={styles.container}>
            ...
            {moreCount > 0 && (
                <ShowMoreContentRow text="Посмотреть все комментарии" count={moreCount} onPress={onShowMoreContent} />
            )}

            <IconTextRow size={22} icon="ios-chatboxes" text="Добавить комментарий" onPress={onAddComment} />
        </View>
    );
};
